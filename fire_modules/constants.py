#   name=AKAI FL Studio Fire - Constants
#   Toutes les constantes extraites de device_Fire.py

from midi import *
import harmonicScales
from harmonicScales import HARMONICSCALE_LAST

FLFireDeviceName = 'Akai Fire EndGAme'
PadsW = 16
PadsH = 4
PadsStride = 16
...
SM_SetAsSingle = 0x0B
SM_StepEditSync = 0x10  # step edit: sync step/pitch offsets across devices
...
ModeNamesT =('Step seq mode', 'Note mode', 'Drum mode', 'Performance mode', 'Step edit mode', 'Analyzer - Left', 'Analyzer - Right', 'Analyzer - Mono', 'Chord select mode')
...
SlaveModeLayout_Left = 1

SlaveModeLayout_Last = 1
SlaveModeLayoutNamesT = ('Right', 'Left')
SlaveModeLayoutXShift = (16, -16)
SlaveModeLayoutYShift = (0, 0)
