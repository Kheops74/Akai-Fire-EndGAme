...
# ==========================================
FIXED_SENDKEYS = {
    'row3_10': ('F6', False, False, False, '', 0xFF8000),
    'row3_11': ('F7', False, False, False, '', 0x0000FF),
    'row3_12': ('F9', False, False, False, '', 0x00FF40),
    'row3_13': ('F5', False, False, False, '', 0xFF00FF),
    'row4_10': ('F10', False, False, False, '', 0x51FF51),
    'row4_11': ('', True, False, False, '', 0xFFFFFF),
    'row4_12': ('', False, True, False, '', 0xFFFFFF),
    'row4_13': ('', False, False, True, '', 0xFFFFFF),
}
